...
<div class="pricingTop">
	<h1>Web Packages</h1>
	<h2>Please contact me if the below packages dont fit the scope of your web project.</h2>
	<h3>These prices should be used as an indication only. I do offer cheaper & more expensive alternatives.</h3>
</div>
<div class="wrapper">
	<div class="pricing-prices">
		<div class="price-left price-badge">
			<div class="pricing-inner">
				...
				<div class="pricing-inner-list">
					...
					<p>Mobile & Tablet friendly</p>
					<p>Optional CMS (Wordpress)</p>
				</div>
			</div>
		</div>


		<div class="price-center price-badge">
			<div class="pricing-inner">
				<h4>E-commerce</h4>
				<h5>Starting at</h5>
				<div class="pricing-inner-price">
				...
				<div class="pricing-inner-list">
					...
					<p>Mobile & Tablet friendly</p>
					<p>Update content/products yourself</p>
				</div>
			</div>
		</div>


		<div class="price-right price-badge">
			<div class="pricing-inner">
				<h4>Premium</h4>
				<h5>Starting at</h5>
				<div class="pricing-inner-price">
